...
const InputContainer = styled.div<{ $hasError: boolean; $hasIcon: boolean; $iconPosition: 'left' | 'right' }>`
  position: relative;
  display: flex;
  align-items: center;
...
const StyledInput = styled.input<{ $hasError: boolean; $hasIcon: boolean; $iconPosition: 'left' | 'right' }>`
  ...
  border: ${theme.borders.width.thin} solid ${props => 
...
const HelperText = styled.span<{ $isError: boolean }>`
  ...
  color: ${props => props.$isError ? theme.colors.error.main : theme.colors.text.secondary};
`;
  ...
  (
    ...
    return (
      <InputWrapper $fullWidth={fullWidth}>
        ...
        <InputContainer $hasError={hasError} $hasIcon={hasIcon} $iconPosition={iconPosition}>
