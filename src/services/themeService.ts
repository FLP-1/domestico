...
function getThemeFromEnv(): Theme | null {
  ...
  return {
    colors: {
      ...
      text: process.env.NEXT_PUBLIC_THEME_TEXT || 'inherit',
      textSecondary: process.env.NEXT_PUBLIC_THEME_TEXT_SECONDARY || 'inherit',
      border: process.env.NEXT_PUBLIC_THEME_BORDER || 'transparent',
      shadow: process.env.NEXT_PUBLIC_THEME_SHADOW || 'transparent',
