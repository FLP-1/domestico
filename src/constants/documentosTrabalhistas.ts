...
import { TipoDocumentoTrabalhista, CategoriaDocumento } from '../services/documentTrabalhistaService';
 ...
 */
export function getTipoDocumentoInfo(tipo: TipoDocumentoTrabalhista): TipoDocumentoInfo {
  return TIPOS_DOCUMENTOS_TRABALHISTAS.find(t => t.tipo === tipo) || TIPOS_DOCUMENTOS_TRABALHISTAS[TIPOS_DOCUMENTOS_TRABALHISTAS.length - 1]!;
}

/**
 * Obter tipos de documentos por categoria
 */
export function getTiposPorCategoria(categoria: CategoriaDocumento): TipoDocumentoInfo[] {
