...
export const useTheme = (
        ...
        if (useCentralizedConfig && config) {
          const mergedTheme: ProfileTheme = {
            ...
            colors: {
              ...
              status: {
                success: config.colors.success || 'transparent',
                warning: config.colors.warning || 'transparent',
                error: config.colors.error || 'transparent',
                info: config.colors.info || 'transparent',
              },
            },
          };
  ...
  const colors = {
    ...
    status: currentTheme.colors.status || {
      success: currentTheme.colors.success || 'transparent',
      warning: currentTheme.colors.warning || 'transparent',
      error: currentTheme.colors.error || 'transparent',
      info: currentTheme.colors.info || 'transparent',
    },
  };
