...
import {
  validarSelecaoCompleta,
  filtrarPerfisValidosParaGrupo,
} from '../../../utils/profileConflictValidator';
...
export default async function handler(
  ...
  if (req.method === 'POST') {
    try {
      ...
      const grupoSelecionado = user.gruposUsuario.find(
        (g: any) => g.grupo.id === grupoId
      );
