...
**Data:** Janeiro 2025  
**Status:** 🔴 **URGENTE**  
**Motivo:** Conexão automática com eSocial não funciona
...
- ⚠️ **eSocial era diferencial principal** na proposta de valor
- ⚠️ **Preços justificados por eSocial automático**
- ⚠️ **Expectativas não alinhadas com realidade**
...
- [ ] `src/pages/subscription-plans.tsx` - Página de planos
...
- [ ] Atualizar README.md
- [ ] Atualizar página `subscription-plans.tsx`
...
3. Comunicar mudanças claramente
4. Focar em anti-fraude como diferencial
