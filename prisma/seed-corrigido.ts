...
/**
 * 🌱 SEED CORRIGIDO - LÓGICA CORRETA
 * Um usuário pode ter o mesmo perfil em grupos diferentes
 * Apenas não pode ter o mesmo perfil duplicado no mesmo grupo
 */

async function main() {
  console.log('🌱 Iniciando seed com lógica correta...\n');
  ...
  if (usuario) {
    ...
    console.log('    • Usuário pode usar qualquer perfil em qualquer grupo');
    console.log('    • Perfil FAMILIA pode ser usado em todos os 3 grupos');
    console.log('    • Perfil EMPREGADO pode ser usado em todos os 3 grupos');
    console.log('    • Apenas não pode ter o mesmo perfil duplicado');
  }
  ...
  console.log('  3. Usuário pode combinar qualquer perfil com qualquer grupo');
}
