...
Foi criado o arquivo `src/config/theme.ts` que define todos os _design tokens_ da aplicação. Este arquivo substitui completamente os valores hardcoded no código.
